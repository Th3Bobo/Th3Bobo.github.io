...
squig=W the=1A <-=1y Pull=1z http=1m 1n blogspot=1o com=1p  
*/
var nopage;
var jenis;
var nomerhal;
...
function loophalaman(banyakdata) {
    ...
    html = '<div class="paginator" id="paginator1"></div><div><a href="http://snowwhitehills.blogspot.com" style="font-size: 7pt; float: right;" target="_blank"><- Pull the Squig</a>';
    if (blogPager) {
