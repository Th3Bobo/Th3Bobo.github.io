...
quotes[41] = "\"Smell that? That\'s destiny&#8230;\"%n\"Funny, the only thing I smell is manure\"";
...
titles[61] = "Chaos";
quotes[61] = "Despair! The age of mortals is ending. Time drains away and the stars fade from the skies one by one. The bitter spawn of night crawls from the darkness to possess the world for eternity to come.%n%nFools! Take refuge in faith or flee into the depths of madness, for no other hiding place remains.%n%nThe Realm of Chaos is begun.";
...
titles[93] = "Chimera";
quotes[93] = "Most bizarre of monsters is the dreaded Chimera: it\'s body is a size of a house, and has wicked claws longer than daggers. It\'s tail lashes like an iron whip, and it\'s huge leathery wings carry it through the skies.%n%nThis loathsome creature has three heads. One of them is horned, like a head of a ram: other is like that of a vast lion: the third head is the most frightening of all: it that of a scaled dragon, and it belches forth noxious smoke and scorching fire.%n%nChimera hunts in the northern wastes, and meat of men is it\'s delicacy: it will hunt relentlessly through day and night to capture it\'s prey.";
...
quotes[105] = "Cher-holera, tie-eye-phoid, cern-sum\'shun, hally-toze-iss! Black plague, white plague, bloody red \'n\' brarn plague!%nCan-ker, way-ster, foot-an\'-marf, fester!%nNew-moniaaa, bu-bonicaaa, neeeew-mo-niaaa, beeew- boney-caaa!%nRunnin\' sores, seepin\' sores, rottin\' sores, weepin\' sores!%nEh-emfer-seemer, die-eye-a-rear, nasty caser wax in yer ear!%nLerr-ustrian runs, Cathay tum, Tilean sick-nerrse of ther thumb!%nNew-moniaaa, bu-bonicaaa, neeeew-mo-niaaa, beeew- boney-caaa!%nSmall pox, big pox, chicken pox, pig pox!%nDiseases of the eller-ment\'ry kind, unease of the alley- ment\'ry kind!%nCommon cold, infler-wenzer, nasty rash, dis-temper!%nNew-moniaaa, bu-bonicaaa, neeeew-mo-niaaa, beeew- boney-caaa!";
...
quotes[113] = "I leave you this gift. In my final days, I found cause to use it twice and I know you will guard this secret well. It is well known that a stake through the heart of a Vampire shall sunder it. A Werewolf fears silver. A Liche abhors fire. Spirits recoil from the memories of their fragmented past. But one truth binds all the beasts that live on both sides of the world. One thing they all fear.%nAnd this truth, I gift toyou. Hold it close and do not squander it\; for there is nothing more terrifying to the Undead than a single utterance of the word — Kriesten. Do not say again. You will not need to. Hearing the word will cause the creatures of the night to stop in their tracks for a few moments, giving you a birth to escape. Run then, as fast as you can. And never look back, for the creatures of the night are not fond of tricks.%nRemember. Do not abuse this gift. And do not say it more than once. Or they will come to find you.%nGo in peace, my brother.";
...
quotes[135] = "A Finger of Doom is just enough%nTo lay a Minotaur,%nA Finger of Doom is just enough%nTo push him through Death\'s Door,%nIt\'s full of magical power,%nThe energy of the warp,%nA Finger of Doom is just enough%nTo slay a Minotaur.";
...
quotes[188] = "You hold in your hand the work of a lifetime. To compile this tome I travelled thousands of miles, learned dozens of languages, fought to save both my life and my soul, lost my left hand and nearly my tongue! Though age now dims my eyes, I can go to Morr\'s Realm content that no finer study of the monsters of the Old World has yet been written.%nThe greatest irony of all is that I had no intention of writing a book such as this when I first became of a man of letters. When I was young, I had just graduated from the University of Altdorf when I had my first run in with a true monster. I was riding to Wurtbad to see my family when I came upon a scene of carnage in the forest. A war herd of Beastman had attacked%na group of pilgrims and killed them to a man. It was a gruesome sight, more so because a lone Beastman had stayed behind to feed on the rather large corpse of a cheese maker. When I came upon the scene, the creature looked up from its meal. I can still see its goat head and horns and%nthe bestial cast of its features. I can see the way its bloody mouth foamed when it realised there was fresher meat on the road. I can see the black depths of its eyes and the cruel barbs of its blade. I drank in this scene, dumbstruck, as the Beastman leapt over corpses and raced for my horse. After years at the university, I was so used to studying things objectively that it took me precious seconds to realise that this was not the moment for detachment. This creature meant to kill me and I needed to do something about it before the Beastman used my vitae to wash down the cheese maker.%nI managed to draw, cock, and fire my pistol and just in time too. The Beastman was in mid-leap when my pistol ball caught it in the chest and ended its life. As it lay dying, the creature spoke, or so it seemed to me. It was no language I had heard before, however. Fascinated, I dismounted and approached the dying Beastman. It looked at me with those eyes and seemed to curse me as it died. I stood there for a long time, staring at the corpse. The Beastman was a monster, clearly, but what more did we know about such creatures? It had language surely and the Beastmen seemed to have%na society of sorts. What was it that made them monsters, I wondered? And what could Humanity learn of such creatures to safeguard itself against further depredations? To unearth such truths and to expand the knowledge of our glorious Empire—that would be a worthy undertaking, I decided.%nAnd that is how it began. My curiosity blossomed into a series of journeys, each more perilous than the last. Fifty years I spent on the road, gathering up all the information I could find. I should have died a hundred times over but Fate was my guide. I persevered and over the years the Work took shape. The result of these decades is Perilous Beasts\: A Study of Creatures Fair and Foul.%nYou will no doubt notice, gentle readers, that much of this book consists of quotations or transcribed testimony from witnesses, experts, and even the witless. It was my intent to show the breadth of opinion and thought on these creatures, with words from the most ignorant peasant to the most eminent scholar. I have also added my own thoughts, based on my research, interviews, and findings. Should Shallya grant me more years, I may yet write of my own adventures compiling this book, but such details are not germane to the work and my hubris is not such that I must make this book into my story.%nI began this tome as a search for truth and while I\'m certain there is truth in these pages, even I can\'t tell you exactly where it lies. I have sought to illuminate the threats that face the Old World but only Lord Sigmar can protect us from the machinations of evil and the enemy within. May he guide and watch over us all.";
...
titles[213] = "Khemri";
quotes[213] = "No, I beg of you, master. Do not take the caravan into the deserts of Khemri, said Salib, the highly agitated caravan guide.%n%nNo more of your tales, Salibm cursed Giles de Moussant.%nI\'ve never met a people as superstitious as you lot. We have plenty of supplies. What can go wrong?";
authors[213] = "Last Words of Bretonnian Tradesman Giles de Moussant";
titles[214] = "Khorne";
quotes[214] = "By order of the great god Khorne%nwhose name I called upon extolling his glory,%nhe commanded%nthat I should assail my enemies.%n%nWhen the command of Khorne,%nmy lord, came to my ears%nFrom Wastes I departed to Kislev I marched straightaway.%n%nThe boyars of Kislev%nmustered their fighting men against me,%noffering resistance in battle.%n%nI grasped in my hand the mighty axe,%nthe weapon which Khorne had granted me.%nLike a linon I raged%nI butchered them like sheep%nwith my terrible weapon.%n%nNot a man among them escaped.%nTheir corpses I skewered on stakes,%nwith their skulls I covered%n the altar of Khorne.";
...
titles[223] = "Kislev";
quotes[223] = "If you kill one man you are a murderer.%n%nIf you kill ten you are a monster.%n%nIf you kill a hundred you are a hero.%n%nIf you kill ten thousand you are a conqueror!";
...
titles[225] = "Lustria";
quotes[225] = "From dark playce I came, and to darker places still I travel, dear heart. Wyrm-midden and filth my crib, man-flesh and dead-thing my down. To the coast of far away land I sailed, to delve in dusty place. Not for glimmer, nor spark, but for Lizard-wyrd parchment and age-crusted name.%n%nSecrets and lies, from the birth of time, so all that is hidden be mine, my dear.%n%nSlime-thing lovers call sailors to salty death in my name. With a touch, ge rises once more, brine-blood vigor her delight. Her kiss is clammy little death. Her song calls men from every land, and my servants walk the land of swamp, doing death for all time.";
...
titles[227] = "Lustria";
quotes[227] = "Lizard-stone tumble, and dead grey-meat my supper, the names of the Eldest spill from my lips, my love. Axolotl. The City of Lizard no more. Its secret places, secrets abhorred.%n%nBut now High-Lizard cares. Cares to curse. Curse him thrice in payment shall I.";
...
titles[233] = "Lustria";
quotes[233] = "Now Lizard-things tremble, and stranger wreaks mis-chief across the land of the Eldest. Glimmer-greed grips the hears of some, while others seek words, and others seek blood.%n%nWho prevails, I care not. I shall endure. Lizard-thing shall die, and green-flesh shall wither. The Names of the Eldest shall be mine, and all dead-things whisper my name, my love.";
...
titles[237] = "Lustria";
quotes[237] = "Woe to the warm-bloods who would despoil our realm, for their craving for trinkets and baubles drives them ever deeper into lands forbidden to them. Cast them out, show them no pity, feed their carcasses to the beasts of the jungle and leave their bones to blanch upon the golden shores of our land.%n%nLet them see that it is folly to intrude upon the domains of the Lizardmen.";
...
titles[245] = "Mermaids";
quotes[245] = "To drown would not hurt,%nAll they would find is my ale and my shirt.%nBut the Mermaid\'s away,%nAnd the ocean does not want me today.";
...
titles[264] = "Orcs";
quotes[264] = "Gobbos fer dinner! Gobbos fer tea! Gobbos when u want \'em! Gobbos fer me!%n%n(Note\: the Orcs will substitute the word \'Gobbos\' with something appropriate to the occasion, eg, \'Stunties\', \'\'Umies\' or \'Ratsies\'.)";
...
titles[279] = "Perilous Beasts %n A Study of Creatures fair and foul";
...
authors[313] = "Anon";
titles[314] = "Siege";
quotes[314] = "Festag, 30th Sigmarzeit 2399. Today, we came closest to defeat, and have suffered much loss of life. For nineteen days now, the orcs\' stone thrower has been pummelling the north wall. Just after noon today a particularly heavy stone smashed into the north-east tower, about nine feet above the base, and it collapsed. Six men were carried to their deaths.%n%nWithin minutes, the foe responded. Six enormous trolls and a war-leader mounted on a wolf led fifty of their number against the breach. Although the wall remained nine feet high, there was sufficient rubble thereabouts to make the ascent easier. Within minutes, we were hand-to-hand with the foe in the ruins of the tower and suffering grievous losses. Unable to use our bows, we were forced to trade blow for blow, as the fight spilled into the courtyard. Two fanatical goblins whirling enormous spiked balls on the end of stout chains joined the battle, and most of the enemy host pressed at the back of their ranks.%n%nFor three hours we struggled, but finally the assault was repulsed. We were aided by the final collapse of the rest of the tower, which buried a regiment of goblins, and starved the front ranks of reinforcement just when we had a slight advantage. We burned the trolls who were trapped inside, and put the goblins to the sword. The foe had left forty-five of their number slain - and we had twenty-five dead, two-score wounded, and others buried beneath the masonry. The rest of us worked like demons to restore the wall using the fallen stone to build a rampart, and clearing the loose rubble which had made a ramp on the out side. A wooden wall behind the first was also commenced.%n%nAt dusk, the goblins began firing their engine once again&#8230; ";
...
quotes[371] = "Ancient walls crumble, old hearts despair. In the baleful light of Morrslieb\'s eerie glow, the bewitching gale of eldritch power makes frail mockery of earthly  stone and brick-built rampart. Centuries old bastion and iron fort, long assumed impregnable, are broken and smashed asunder, rendered unto dust by the tempest.%n&lt;div align=\"center\" class=\"noborderdv\"&gt;&lt;img id=\"Hrasbild\" src=\"https\://lh6.googleusercontent.com/-EdN6OX1hB3Q/VNfipUipM5I/AAAAAAAABk8/sU9P8t7vi_o/s50/Heavens.png\"&gt;&lt;/div&gt;%nA great conflagration of twisting, swirling magic rises up, engulfing the city in a deadly fountain of caustic faerie-fire. The flame\'s lurid hues leap and swirl franticly. First slick red of blood, then cold mysterious blue, gives way to the ghastliest of greens. At once fetid brown filled with death and decay, becomes a soulless black laced with blinding white. An endless cascade of colour-splashed insanity.%n&lt;div align=\"center\" class=\"noborderdv\"&gt;&lt;img id=\"Hrasbild\" src=\"https\://lh3.googleusercontent.com/-yOYTMBceVOw/VduPSL0e6OI/AAAAAAAAB3E/3mSFDIL5lPc/s50-Ic42/Fire.png\"&gt;&lt;/div&gt;%nThe firestorm strips bare the cobbled streets and lofty balconies, and lifts tiles from olden roofs, scattering debris all over.The crackling and roaring of the arcane winds, is drowned by an almighty crash as the very sky is ripped apart. From realm of daemon pours forth the horde, of dread nightmares made flesh. A gibbering, capering, caterwauling, howling menace, the inhuman tide brooks no resistance, all defenders are swept to oblivion.%n&lt;div align=\"center\" class=\"noborderdv\"&gt;&lt;img id=\"Hrasbild\" src=\"https\://lh3.googleusercontent.com/-spzhSjsorPE/VduPR1vEQkI/AAAAAAAAB3A/_yQp-UKmO_c/s50-Ic42/Death.png\"&gt;&lt;/div&gt;%nSuch is the fate of things, when the bad moon rises too close for comfort. Time forgotten magics are now easily recalled, venerable magic items are charged with burgeoning energies, dusty parchments give up ancient secrets anew. Wizards, warlocks and witches are twisted by fresh ambition, yearning to wield the supernatural forces unleashed. Places of power are exposed by the gusting weirdness, and the world is shaken by the wrath of the storm.";
authors[371] = "";
...
quotes[379] = "Where march you, men of Reikland.%nWhere carry you halberds and sword?%n%nWe march to war for our Emperor%nAnd Sigmar, our saviour and lord.%n%nTomorrow we go to war%nto face the hosts of Chaos.%n%nTomorrow we will be buried%nin the cold graves that await us.%n%nAnd when this war is done,%nand my body lies on the field at night%n%nHear my prayer, save my soul,%nLord Sigmar take me to your light.";
...
quotes[389] = "I have seen the doom of man. It is written in the stars, an imen borne upon the twin-tailed comet that blazes bright across the firmament.%n%nThe barbarous tribes of the north will see it as a sign of their final victory over the world. Yet the children of the Heldenhammer shall look upon it in hope and fear alike. Hope, that heralds the return of their most glorious champion. Fear, that it signals the death of all their kind has achieved.%n%nAnd they are right to do so.%n%nIn the north, foul hordes flock to the banner of the Three-Eyed King. Like blood pulsing from a wound in the world\'s crown, they march south to bring the touch of Chaos to all. The Everchosen\'s warlords shall plunge their blades deep into the civilised realms, looting fallen empires for their own glory.%n%nBrothers three shall bring low the Empire of Man. It is they who will muster the plague-kissed in their master\'s name. It is they who will cast the curse of unbound life, a curse that will bring primal disorder to a world of hard-won progress.%n%nUnited, the lords of disease shall bring the Old World to the brink of ruin - ruin from within, and from without. All things clean and true shall sicken and fade. The gods of man shall fade with them, until only death holds the key to salvation.";
authors[389] = "These are the End Times.";
titles[390] = "The End Times";
quotes[390] = "I have seen this world\'s demise. Morrslieb, the accursed orb, waxes against crimson skies. Magic rises and reality subsides, leaving only madness in its wake. Vermin cease their gnawing and swarm to the surface, answering their horned master\'s call. First to fall are the temples of the Old Ones, abandoned by defenders who know that the end draws near.%n%nMankind does not recognise its doom - not yet. They hear only the drums in the north, and know that war is come. Some will fight. Others will abandon reason, seeking salvation in scripture or the scourge. They are deceived. The Dark Brothers are stronger than ever before, and the old gods fade. Only in death will any respite be found.%n%nIn a land of mist, the danger is closer still. Pride has ever been the folly of that shrouded land, and so it will be again. When the dragons fly as one, an ancient lie will at last be exposed, a revelation that will shake Ulthuan to the roots of its mountains. The mirror of light and dark will shatter, and Aenarion\'s heirs will fight for the legacy of Khaine amidst the ashes of the phoenix.%n%nThe three-eyed king has long awaited this moment, the hour in which his destiny is at last unveiled. He leads an army of madness and rage, against which no sane being would willingly stand. Perhaps I am not sane, as I will fight one last time. Not for victory, but for survival, for the hope that a spark can endure. It is a slender hope, and the laughter of Dark Gods rings loud in my ears.";
...
quotes[392] = "Esteemed Colleagues.%n%nFollowing, you will find the journal of a Bürgermeister from a small town deep in the wilds of Ostland.%n%nWhy, you ask, have I forwarded this wretched journal along? Indeed, the battered and blood-stained original has already been passed around the Imperial Council. It has been read by the academy at Altdorf and by Captains as part of their training. This journal is well known to Witch Hunters and Priests of Sigmar. Why do I spread this tale about the doings of a small colony of tradesmen and farmers?%n%nNo matter which provinces you serve, no matter which tour of duty you pull, no matter what town you call home, the enemy is out there waiting. He is always moving against us.%n%nLet this sorrowful tale serve as warning. Do not drop your guard. Never open your heart to despair. There are many paths by which the enemy may attack, and sometimes these routes lie within each of us.";
authors[392] = "Captain Strasse%nSole Survivor of Nordsteim";
titles[393] = "The Journal of Bürgermeister Albrecht Nusbaum";
quotes[393] = "Today was the celebration of my 6th year as Bürgermeister of Nordsteaim. Captain Strasse had the entire garrison of troops march through the streets, and there was quite a celebration at the Red Wolf Inn.%n%nMy latest Imperial Reports off to Altdorf are full of raging successes (all true). If I happened to omit the atrocities that recently occurred on the outskirts of town, then I hope Sigmar can forgive me. Still, how does the burning of a few outlaying cottages compare with increases in population and taxes?%n%nWhen I was first posted here, it was just a crossroads and a clearing in the forest. Now we have a proper town. A single incident of some banditry and some burned houses may alarm the locals, but I don\'t want this information passed any further up the chain.%n%nStill, that reminds me to put up notices. Rumours that the villagers\' bodies were half-eaten and savaged are just not true. Must remember to ask the good Captain Strasse exactly what he thinks did happen to the bodies.";
authors[393] = "from the Journal of Bürgermeister Nusbaum%nYear 6. Day 1";
titles[394] = "The Journal of Bürgermeister Albrecht Nusbaum";
quotes[394] = "Bad news today. At dawn everyone could see the pall of smoke hanging over the northern woods. Riders were sent out and returned with news that the woodsmen\'s cottages up in Northcuttings were naught but soldering ruin.%n%nEven worse, after investigating with a patrol, Captain Strasse has returned, and now even he is telling tales and discussing possible raids! I warned him not to follow such a course, but the men had already heard it. Hoof prints in the mud indeed - nonsense!%n%nNordsteim may be on the border - in truth, we may be far out in the wild. We may be under the very eaves of the Forest of Shadows, but those are tales of a different era - just stories to scare children. Now is the reign of Karl Franz, for Sigmar\'s sake!%n%nStill, there was no dissuading the Captain. A mounted party left immediately to travel the roads and warn travellers and the southern villages before reporting in to the Ostfort. If this group should run into a trade caravan, then all my work and efforts will be put back 5 years. If only they\'d let me handle things my way.";
authors[394] = "from the Journal of Bürgermeister Nusbaum%nYear 6. Day 21";
titles[395] = "The Journal of Bürgermeister Albrecht Nusbaum";
quotes[395] = "Ever since the patrol heading south to the Ostfort was ambushed, things have gone from bad to worse. It is those abominations, those beasts that walk as men.%n%nThose who made it back from the patrol were few. We have tried several more sorties, two by roadway and one in which the brave souls attempted to throw off the forest devils by heading along little-known game paths. All met with failure, and none have made it through to tell of our plight. We know this from the gruesome trophies left on poles along the roads. The Ostfort is but a 4-day journey, but we have no volunteers. We are surrounded and down 32 soldiers.%n%nCaptain Strasse has called up the militia, and even as I write this, I can hear them drilling. Many of the settlers have been slain, but more still have moved back to town with there belongings in carts. They all fear to take the roads out of Nordsteim. The days are filled with work. Trees have been felled, watch posts built, and rough palisade has gone around the entrance to town. All of this is happening at a time when so many should be harvesting the autumn crop before winter.%n%nAnd yet I must report that the days are better than the nights. The foret never seemed so dark and foreboding. Watchfires at all the road entrances burn until the sun rises. Even with the shutters closed and barred, the night is full of sounds. We all sleep uneasily.";
authors[395] = "from the Journal of Bürgermeister Nusbaum%nYear 6. Day 36";
titles[396] = "The Journal of Bürgermeister Albrecht Nusbaum";
quotes[396] = "Two nights in a row, they have come to test our defences and not found us wanting. It is well that the trees around the town were felled. This has proven to be a killing ground for our archers and handgunners.%n%nWith brazen horn blasts, the beasts announced their comming last night. I could hear their horrible voices, guttural and low, but there were words in the growling - although I could not understand them.%n%nDespite our sleepless night, the morning broke fair, and crews ventured out to clear the dead. Well over a dozen of the foul creatures have been counted. Some are large with great horns. All are to be burned on the bonfires.%n%nThe beasts have the low cunning to surround us, but our stake walls have vexed them. I\'m hoping a force from the fort should investigate any day now. They will clear the roads, and it will be safe again soon.%n%nWe have gathered what food we could from outlaying areas and stocked it in the Red Wolf Inn. I have supervised this. During an attack, this Inn is the meeting spot for those who cannot defend the walls. I myself have kept an eye on the poor souls who gather here during the nights. Why did I ever come to this forsaken forest?";
authors[396] = "from the Journal of Bürgermeister Nusbaum%nYear 6. Day 53";
titles[397] = "The Journal of Bürgermeister Albrecht Nusbaum";
quotes[397] = "The gaps in our wall have now been mended, but from now on, I shall think of the structure as more of a fence than a wall. There was more than savage cunning in last night\'s attack. Some creature of greater intelligence seems to be driving the Beastmen now. They no longer announce their charges with horn blasts and instead prefer to creep close in the dark before launching an assault. The men on watch are weary - every shadow sends out an alarm. Last night was the worst attack yet.%n%nWhile a force tried to batter the front gate and another tried ladders on the west wall, a trio of enormous creatures attacked the east wall.%n%nWhat monsters those creatures were! They walked on four legs yet were two or three times as tall as a man. The lower half was scaled and reptilian, but their torsos and heads were man-like and full of twisted evil. Their tremendous axes left gaping holes in the wall. Entire log, winched into place by a half dozen men were uprooted and scattered.%n%nCaptain Strasse himself sounded the alarm and drove the monsters off. One was trapped in a pit and slain. Its roars were deafening. Elsewhere, we counted 57 dead beasts, and their sickening carcasses were dragged off and burned. We lost another 21 men. We can ill afford such exchanges. The worse news is that our gunpowder supply was depleted by the attack.%n%nThe fields are all despoiled, and no food can be found there. We cannot hold out much longer. I do not want to fall in this Sigmar-forsaken forest. Perhaps they will listen to a barter?";
authors[397] = "from the Journal of Bürgermeister Nusbaum%nYear 6. Day 57";
titles[398] = "The Journal of Bürgermeister Albrecht Nusbaum";
quotes[398] = "I have been in the woods now for several days. It is deathly silent, but I can feel the eyes of the forest upon me.%n%nIt is hard to keep track of time, but I believe it has been 10 days since the order of half-rations was enacted. I complained to Captain Strasse, but he had bseen fit to burst into my home and carry everything I had stored there. I told him that if I were more confident in his defence, then perps I might not have hoarded such a cache. His reply was that if he could spare the men he would have had me watched. It is clear from this point that the Captain\'s words have turned my own people against me.%n%nWhat was I to do? There are under 100 men left in the garrison - well under half strength, barely enough to man the walls. A hero\'s death is for fools.%n%nI will not detail how I braved the woods or parleyed with abhorrent creatures lest this journal be foundd and I be judged by lesser men who were not there.%n%nGetting the guards at the southern gate to abandon their post was easy and left the southern road open to me. An open road for open gates, that was the bargain. Fast as I and my pack mule might travel, I could not escape the sounds. There will be no survivors but me. I will reach the Ostfort in 2 days. I will make the report of my escape and restart my life.%n%nThe journal was discovered on Albrecht Nusbaum\'s corpse. His remains were found nailed to a post just outside the Ostfort.";
authors[398] = "from the Journal of Bürgermeister Nusbaum%nYear 6. Day 70";
...
quotes[403] = "Owt in shaden wodespan, dwelt the murdrus beaste,%nVittaling on the sack-for-homes, gorge-laden with his feaste,%nStalking \'tween the leafen glade, preying \'pon the weake,%nGlutting the hardy and the poor, e\'en dinning on the meake.%nAnd noth there was, that brave the woode, Noth amidste the sword-handy and the goode, \'cept a gallanting Knacht from far Breton, Who trot a-quest to lay sword on.%nAnd kinder Tomas Wanderer, \'nored his mother\'s tonge,%nFor Tomas he listened nither, much so for kinder yonge,%nHe hitched up sweepstik ponie, waving woden sworde,%nAnd sleeked out to the wodespan, footestepping Breton Lord.%nThe snilvin Foole pranced at the bridge, and cry cackle at the boye,%nGo sleekin not with Beast of Teeth, not slitblood with some toy.%nBut he was the Fool and none to mind, and Tomas heeded not,%nSlug saddleshrag on destrier and westered at the trot.%nYonge Tomas spired the girthen oake and tarried there a while,%nThen \'stead of easting back again, Tom rid another mile.%nHe cleft the black leaf shabbery and swaydin blood-daubed vine,%nCarefree took forth his knapper-foode and fettered there to dine.%nThe wodecutman found Tomas there, thrice spanned him \'round the ear%n\"Be fangs and claws for you, my ked, if sunfall shrouds you here\" %nWith axehaft brunting younge man\'s hide, the wodesman bade Tom home,%nBut Tomas mere a squallsome ked, and so he bide to roam.%nOnnerin and inneron, through garbled bole and threshy twine,%nTomas goaded stick-horse on, as ruddy sun wed pale moonshine,%nAnd there aminst the sprickly bushe, he spied the lairing of the brute,%nStepped out brightly \'pon his steed, thru\' graping branch and scraping root.%nAnd there bale-eyed the spiten Beast, all goried hornes and slives and fangs,%nYet brisky Tomas ventured on, he couched no dread, nor homeward pangs.%nThough brave Knact bidden to the grave, with woden sworde aloft%nPlucky Tom brandished at the Beast, who marred him with a scoff.%n\"What mires you here, younge smoothskin- born?%nDid you mother about me warn?\"%n\"I have no fear!\" Tom cried aloud, Horsing forward \'til Beast he growled.%n\"I shall wolfe you flesh and snap your bones, Skrind your folkland burne their homes.%nFor mocking ked to dare my rage,%nYour jibe it traps me like a cage.%nThe unclaimed ones must dread my kinde, Can never squander fear behind.\"%nSo Tomas Wanderer was no more, who never did no goode,%nSo remember poor Tomas, and roam not in the woode.";
authors[403] = "";
...
titles[435] = "WANTED%nFor expedition to the mysterious east.";
...
quotes[445] = "HALFLING FIGHTING COCKS%nExpert Marksmen, Trackers &amp; Woodsmen. Baggage Train guarding a speciality.";
...
titles[478] = "Ogres";
quotes[478] = "Pray hark! To brave Sir Baldrin\'s tale%n%nWho traveled far to mountain vale,%n%nTo slay an ogre, fiend or drake%n%nAnd meet his \'Lady of the Lake\'%n%nDismounting now, Sir Baldrin strode%n%nFurther still up mountain road,%n%nFrom nook and cranny, hungry eyes%n%nDid stare, then widen in surprise%n%nAnd thus it was that Ogre foul%n%nStepped out, and gave a fearsome growl\:%n%n\"I\'ll grind yer bones to make my bread\"%n%nThe Knight replied \"I\'ll have your head!\"%n%nSir Baldrin charged, with greatsword raised%n%nHis downward stroke the Ogre grazed,%n%nThe monster\'s club came arching down,%n%nAnd landed hard on Baldrin\'s crown%n%nThere came a grisly snapping sound%n%nThe Knight was pitched unto the ground,%n%nBut here Baldrin\'s tale does not end,%n%nWhat awaits our Brettoni friend?%n%nHis guts were gobbled then and there%n%nThe rest dragged back to Ogre\'s lair%n%nSir Baldrin\'s heart, so stout and true%n%nTook pride of place in wholesome stew%n%nHis legs were chewed, his fingers grilled%n%nHis lungs with Garlic butter filled%n%nBones were snapped and marrow bled%n%nThen powdered into Ogre bread%n%nChain-mail fitted Ogre\'s arm%n%n(Tho not with Baldrin\'s dandy charm,)%n%nHis great sword, once a weapon dire%n%nSpitted meat on open fire%n%nHis icon—thrown into the hearth%n%nHis breastplate—now a goblyn\'s bath%n%nHis blanket—used to stuff a hole%n%nHis skull—a hollow drinking bowl%n%nAnd so then this Brettonian\'s fate%n%nWas met upon an Ogre Plate%n%nLet ye be warned\: when eastward bound%n%nPray take some friends, let ye be found";
...
titles[579] = "Mummies";
quotes[579] = "Go not to the mounds on moonless nights,%nseek not the dead to rise.%nRisk not the wrath that sleeps and dreams,%nheed the words of the wise.";
...
quotes[610] = "We are lucky to live in the city, my darling child.%nThere are things in the wilderness.%nDark things. Hungry things. Evil things.%nThose who stray too far beyond the edges of the%nforest are bound to meet an unhappy end.";
...
titles[624] = "MISSING";
quotes[624] = "One pair of earrings in the vicinity of Chez Louis\' Restaurant.%n REWARD for pertinent information or return of items.";
authors[624] = "Contact Frau Oppenheimer, Nordstrasse";
titles[625] = "HELP WANTED";
quotes[625] = "Fleischer\'s Famous Furters, \"The Sausage of choice for the Officers and Men of the Imperial School of Gunnery.\"%nSeveral intelligent and resourceful individuals required for a matter of some delicacy. Excellent rates of pay. Apply in person to";
...
quotes[638] = "Do not harm the innocent. You cannot fight for justice by unjust means.%nUphold justice where law has failed.%nTake the excess from the wealthy to feed the starving. It is no harm to lose money that you do not need.%nBe true to your fellows. Betrayal is a foul deed, worthy of Greenskins and Beastmen.%nAsk no questions of your fellows\' pasts. Every Herrimault has his reasons for fighting and should be judged on his actions now.%nReject the Ruinous Powers, and fight against them even alongside tyrants.";
authors[638] = "";
...
quotes[732] = "Sir Gilbert urged his weary mount into the dreary looking village. The roads here were terrible, and he had a hard time believing this was the route to the Chapel of Shields Burning. But the lord he had stayed with the previous night had been quite emphatic.%n%nAt last, he reached what looked like an inn. Crude emblems were painted on the door. Typical peasant superstition, thought Gilbert. The knight banged his gauntleted fist on the door, but no one answered. Gilbert kept pounding, but something about this was horribly familiar. He lowered his right hand to his sword and looked around cautiously.%nAt last, a voice came from inside. \"Go away!\"%n\"You will open this door this instant,\" the Bretonnian said, lacking any measure of optimism. \"I am Sir Gilbert de Arnaud, Knight Errant...\" He got no further, as the door flew open.%n\"My most humble apologies, lord knight. I had not realised.\" The innkeeper was literally grovelling in the mud. \"The finest room is, of course, at your disposal.\"%nSir Gilbert sighed contentedly. It was good to be home.";
authors[732] = "";
titles[733] = "Did You Know...";
quotes[733] = "That the tallest player ever to stride onto a Blood Bowl field was the legendary Gurk Cloud-Scraper, storm giant half-back for the Asgard Ravens? Standing as tall as nine men, Gurk played in only one match before being barred for life for excessive violence.%nThe shortest player ever was the equally legendary Big Jobo Hairyfeet, opposing captain of the halfling Greenfield Grasshuggers team in the same game, whose sudden and quite drastic reduction in height was the main reason for Gurk\'s ban!";
authors[733] = "";
...
quotes[785] = "In 2470, following years of disenchantment, several of the teams competing the Dwarf \'Stuntie\' Cup competition threatened to leave the leagues they were competing in and form a league of their own. The increase in the throwing game was threatening to end whatever chance of success they had ever had! %nThe resulting World\'s Edge Superleague is a Dwarfs-only League, now trimmed to 12 second-rate teams playing a 22-match season. Curiously, the throwing game dominates! Those World\'s Edge fans just love to see the ball hanging up there while 22 players scramble for the honor of being the one it lands on!";
authors[785] = "";
...
quotes[792] = "Evil Knut of the Asgard Ravens is still the holder of one of the more unlikely NAF records. From 469-2474, over a period of 40 games, he set of 113 traps without sustaining so much as a scratch. In fact, the Ravens got so used to Knut\'s good fortune that their opening play in every game was to have him wander around the pitch setting off spear traps, opening pits and making the arena safe for his teammates. %nKnut finally met his end when the Warhammerers went for broke and mined half of the pitch with explosives. It wrecked their entire arena, killed 7 of their players and brought down the wrath of the NAF, but the Warhammerers were still happy with their choice. \"There is no Knut too tough for us to crack,\" boasted a spokesmen for their owners.";
authors[792] = "";
...
quotes[799] = "Never mind tempting Jeremiah Kool out of retirement - have you heard of the new Dark Elf sensation, meriann Lightning? Various teams have been queuing up to pay a fortune to the Naggaroth Nightwings after Lightning was the only player to come through the door in this year\'s Crush!%nDespite the many offers he has recieved, it seems no other teams have yet been able to tempt Meriann away from the Nightwings. He just couldn\'t refuse Naggaroth\'s guarantee of two fatalities every match - even if this means the Naggaroth cheerleaders become a little short staffed.";
authors[799] = "";
...
quotes[801] = "True conoisseurs of the running game will be devestated to learn that \'Speccy\' McGroan has been cut from the team by the Evil Gits for the 2488-89 season.%n\'Speccy\' who achieved a life time best of 9 fumbles against the Creeveland Crescents last year, was one of those truly incompetent cretins Blood Bowl needs if it is to retain its prime-time status. \'Speccy\' set up some fantastic scrambles for the ball with over 30 fumbles last year.%nAsked about the cut, Evil Gits coach Bargull Whipdeath said \"e diserfed it, so i cutz \'im from \'ere to \'ere\".%nThis might just be jovial banter, however since it is understood by this reporter that the Middenheim Marauders have paid 20,000 Crowns for \'Speccy\' ... to play for the Chaos All-Stars.";
authors[801] = "";
titles[802] = "NAF Facts";
quotes[802] = "It has often been asked, what do sponsors gain from deals with Blood Bowl teams? At its simplest, a sponsorship deal may just entitle the sponsors to free tickets to their team\'s games - and they can be as valuable as diamonds if that team makes the playoffs. In other cases, sponsors pin their hopes on getting extra business through being associated with with a successful team - that was certainly what Wolf Runner Coaches hoped for when they signed a big deal with the Icecastle Wolves (and what a dissapointment they must have had...).%nBut most sponsors are just fans of the world\'s greatest game. As one businessman put it: \"When you\'ve been killing the opposition all week in the office, it\'s good to look forward to a night of entertainment you can take the whole family to\". That\'s why the big-money sponsors will pay thousands of Crowns, just as the Metalworkers Guild did to the Dwarf Warhammerers this season. As one spokesman put it: \"Maybe we\'re just as crazy as they are!\"";
authors[802] = "";
titles[803] = "NAF Facts";
quotes[803] = "What chance do the Halflings have of ever fielding a Blood Bowl side? What chance do they stand of ever even winning their division?%nTo understand the answer, you need to understand how the NAF league organises the fixtures schedule. The 40 teams are grouped into their two conferences and eight divisions, but they can play any other NAF team during the season. So long as they complete exactly 16 fixtures (by complete we just mean arrange... at least twenty games a season are forfeited when one team doesn\'t turn up), each team can play anyone it likes so long as it plays each team in its division at least once (that\'s each other team, Hobgoblin fans!) and doesn\'t play any team more than twice. Actually this rule is often waived. As the Dwarf Giants would put it, \"when we get to them for the third time, they ain\'t the same team\".%nFixtures are organised at a pre-season meeting of the owners. Each brings 16 team socks (or other apparel, in the case of Halflings) to be exchanged for the other teams socks in a frantic meeting. As you might expect, ambitious teams try to arrange a fixture schedule against the weakest opponents possible, which makes the Hobgoblin Team, the Rats and the three Halfling teams very popular. Another consideration is the attractiveness of the opposition; a game agains the Cowboys always draws the fans! Bribes, violence and magic are used to influence the swapping of these socks, and the meeting often lasts for several days until any manager can leave with his sixteen opponents mapped out.%nAfter years of receiving weighty bribes (some of which couldn\'t be eaten), last season the Stunted Stoutfellows managed to get themselves a fixture list which included three games against the Hobgoblin Team, two against the Scarcrag Snivellers and one against the Rats. They won 5 games - matching the club record - and came fourth in their division! Scale that up three or four times, and you can see how they could become a mighty force in the AFC west in three or four decades.";
authors[803] = "";
...
quotes[808] = "In 2435, the Dwarf Giants lost 9 great players when they first list a fire in the dugout to get warm, which melted that side of the pitch then performed a victorious \'high five\' in the End Zone after scoring, which tipped the floe over.%nNorse stadia are now subject to mandatory safety checks.";
authors[808] = "";
...
quotes[817] = "&lt;b&gt;Some NAF Kicking records.&lt;/b&gt;%n&lt;i&gt;Longest Kick-Off&lt;/i&gt;: 406 paces, by Ice Giant Kicker Cloudgirth Mountainhips, vs the Vynheim Valkyries, Norse Challenge Cup, 2485. A spectator watching another game was killed by the ball.%n&lt;i&gt;Longest Kick Landing in Play&lt;/i&gt;: 88 paces, by Darkside Cowboys Kicker Venom of Praetia, vs Asgard Ravens, 2487.%n&lt;i&gt;Longest Kick-Off Return&lt;/i&gt;: 62 paces, by Reikland Reaver \'Fast\' Ben Jansen, vs Elfheim Eagles, 2486.%n&lt;i&gt;Most Players Killed by Booting (Season)&lt;/i&gt;: 12, by Gouged Eye Kicker Trok Elfsplitter, 2487.%n&lt;i&gt;Most Players Killed by Booting (Single Game)&lt;/i&gt;: 3, by Dwarf Giant Grimwold Grimbreath, vs Lowdown rats 2485.";
authors[817] = "";
...
quotes[820] = "How do teams become part of the NAF set-up? The NAF has kept a strict limit on the nmber of teams in the league since 2450, when it took its presetn shape. However there have been changes in its composition since then. One of the most recent teams to drop out of the team was the Wuppertal Wotans, who were wiped out by a freak lightning strike before a vital AFC play-off game in 2483.%nThe vacancy was filled by the Icecastle Wolves - part of the NAF\'s policy of keeping the league\'s racial/social/geographic balance roughly the same over the years. This is intended to keep other teams from arranging little accidents to create vacancies in the league, although there are obviously still plenty of other reasons for a team to have another wiped out!";
authors[820] = "";
titles[821] = "NAF Facts";
quotes[821] = "It\'s an expensive business setting up an NAF franchise. Valhalar Galante, who in 2648 combined the Dar-Ellerath Beechtrees and the Ashvale Valar to form the Elfheim Eagles, was a master of the art of financing a new team. Foreclosing on a mortgage and engineering a successful hostile takeover (non-accountants would call it a war) gave him controlling interest in both teams. He bought the Vale Arena from a thrid Elven team following the collapse of an Elven insurance cartel.%nHe then sold his most experienced players to another new Elven team (the Gladiators), auctioned off both of the other stadiums (which were converted into open-air markets) and hired Perellian Ashblade to build a strong, young team. Finally, he spared no expense in acquiring a powerful mage to act as the team \'masseur\'.%nDespite these tremendous outlays of cash, Galante recovered it all when he bet 200,000 GCs on the Eagles to beat Nurgle\'s Rotters in Blood Bowl XX. He got 15-1 odds, and the rest is history (and totally tax-free).";
authors[821] = "";
titles[822] = "NAF Facts";
quotes[822] = "One of the most bitter rivalries of all time stands bewteen Tomolandry\'s Champions of Death and theWestside Werewolves. Actually, it\'s less of a rivalry and more of a domination - by the Weres.%nOver the years, the Werewolves have run off with essential parts of over 200 of the Champions\' Skeletons. In recent seasons, Tomolandry has refused to even play against the Westside team, claiming that he would rather forfeit one game against them than have his entire team decimated for the remainder of the season.%nRecently, an archaeologist named Montezuma Smith stumbled across the garden bed in which the Werewolves %nhad buried the coveted bits of Tomolandry\'s ex-players. Smith immediately turned around and sold his find back to the Champions for a whopping two million Gold Crowns!%nThe finest of the ex-Champions have been banded together under Tomolandry\'s star apprentice Jocko O\'Maddin %nto form the Tombstone Terrors, the first Undead touring team. The re-energized Terrors have been taking the opposition to their graves and have been so successful that there are rumours that Tomolandry is thinking of forming an all-Undead league!";
authors[822] = "";
titles[823] = "NAF Facts";
quotes[823] = "&lt;b&gt;Some Teams that Failed&lt;/b&gt;%nThe largest team ever raised was the Dark Mountain Spiders of 2338-2342. The Spider King Clakkataulak, found a vein of gold in his mountain lair and signed up all eligible arachnids in his kingdom! Over 900 were registered with the NAF.%nThe Spiders weren\'t a great success, despite their size. Even with eight limbs, they never mastered the throwing game, and their predictable \'scuttle\' attack was quickly found wanting against the Warhammerers\' \'steam-roller\' tactics. By the time the team was abandoned in 2342, there were only eight players left.%nThe Black Mountain Marauders were also disbanded after owner Baron Kurt Herzgerworden promised to cover the team in gold if they won the Border Princes Senior Cup. They did, but only thanks to Hill Giant Freebooter \'Slim\' Thorn. Kurt couldn\'t pay up and hasn\'t been heard from since.";
authors[823] = "";
titles[824] = "NAF Facts";
quotes[824] = "Some teams have been more able to use traps effectively than others in the past, and some have had more than their share of hard luck. The Albion Assassins used a particularly effective trap against the original Scarfaced Scavengers (their present incarnation is their fourth) way back in 2468.%nWary as ever, the Scavengers took the field only after scouring the pitch for hours before the match. Weren\'t they surprised when most of the field (except the section the Assassins were standing on, of course) dropped away into a bottomless pit!%nThe third version of the Scavengers also fell prey to a most devious trap. In a game versus the Naggaroth Nightwings in the Wings underground arena, the Dark Elves lined up without any armour! The drooling Dwarfs took the field, only to find themselves abruptly pinned to the pitch as a powerful magnetic force slammed them and their armour into the dirt.";
authors[824] = "";
titles[825] = "NAF Facts";
quotes[825] = "Evil Knut of the Asgard Ravens is still the holder of one of the more unlikely NAF records. From 2469-2474, over a period of 40 games, he set off 113 traps without sustaining so much as a scratch. In fact, the Ravens got so used to Knut\'s good fortune that their opening play in every game was to have him wander around the pitch setting off spear traps, opening pits and making the arena safe for his teammates.%nKnut finally met his end when the Warhammers went for broke and mined half of the pitch with explosives. It wrecked their entire arena, killed 7 of their players and brought down the wrath of the NAF, but the Warhammerers were still happy with their choice. \"There is no Knut too tough for us to crack,\" boasted a spokesman (it actually says \"a spokesmen\" here, but I guess that was a typo) for their owners.";
authors[825] = "";
...
quotes[829] = "Gort Kindersnap is the longest-serving Ref currently active. The \'Grand Old Man of Blood Bowl,\' as he is affectionately known, has reffed over four complete games!%nDuring that time, Gort has sustained three concussions, two fractures and one conviction for attempted murder.%nKeep up the good work, Gort!";
authors[829] = "";
