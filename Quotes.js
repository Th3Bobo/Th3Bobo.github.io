...
quotes[41] = "\"Smell that? That\'s destiny&#8230;\"\n\"Funny, the only thing I smell is manure\"";
...
titles[61] = "Chaos";
quotes[61] = "Despair! The age of mortals is ending. Time drains away and the stars fade from the skies one by one. The bitter spawn of night crawls from the darkness to possess the world for eternity to come.\n\nFools! Take refuge in faith or flee into the depths of madness, for no other hiding place remains.\n\nThe Realm of Chaos is begun.";
...
titles[205] = "Hope";
quotes[205] = "Life is a spark of light in the midst of endless darkness. We cling to love and hate, joy and pain, belief and fear, for they make us feel alive. Some of us are glorious, mighty men who will forge legends and burn like fiery stars in the darkness, casting the brief hope of life to this world.\nBut in the end we will have to give up everything we have, and descend back to the endless, dreamless darkness, to be forever forgotten.";
...
titles[227] = "Lustria";
quotes[227] = "Lizard-stone tumble, and dead grey-meat my supper, the names of the Eldest spill from my lips, my love. Axolotl. The City of Lizard no more. Its secret places, secrets abhorred.\n\nBut now High-Lizard cares. Cares to curse. Curse him thrice in payment shall I.";
...
titles[233] = "Lustria";
quotes[233] = "Now Lizard-things tremble, and stranger wreaks mis-chief across the land of the Eldest. Glimmer-greed grips the hears of some, while others seek words, and others seek blood.\n\nWho prevails, I care not. I shall endure. Lizard-thing shall die, and green-flesh shall wither. The Names of the Eldest shall be mine, and all dead-things whisper my name, my love.";
...
titles[237] = "Lustria";
quotes[237] = "Woe to the warm-bloods who would despoil our realm, for their craving for trinkets and baubles drives them ever deeper into lands forbidden to them. Cast them out, show them no pity, feed their carcasses to the beasts of the jungle and leave their bones to blanch upon the golden shores of our land.\n\nLet them see that it is folly to intrude upon the domains of the Lizardmen.";
...
titles[245] = "Mermaids";
quotes[245] = "To drown would not hurt,\nAll they would find is my ale and my shirt.\nBut the Mermaid\'s away,\nAnd the ocean does not want me today.";
...
titles[264] = "Orcs";
quotes[264] = "Gobbos fer dinner! Gobbos fer tea! Gobbos when u want \'em! Gobbos fer me!\n\n(Note\: the Orcs will substitute the word \'Gobbos\' with something appropriate to the occasion, eg, \'Stunties\', \'\'Umies\' or \'Ratsies\'.)";
...
quotes[403] = "Owt in shaden wodespan, dwelt the murdrus beaste,\nVittaling on the sack-for-homes, gorge-laden with his feaste,\nStalking \'tween the leafen glade, preying \'pon the weake,\nGlutting the hardy and the poor, e\'en dinning on the meake.\nAnd noth there was, that brave the woode, Noth amidste the sword-handy and the goode, \'cept a gallanting Knacht from far Breton, Who trot a-quest to lay sword on.\nAnd kinder Tomas Wanderer, \'nored his mother\'s tonge,\nFor Tomas he listened nither, much so for kinder yonge,\nHe hitched up sweepstik ponie, waving woden sworde,\nAnd sleeked out to the wodespan, footestepping Breton Lord.\nThe snilvin Foole pranced at the bridge, and cry cackle at the boye,\nGo sleekin not with Beast of Teeth, not slitblood with some toy.\nBut he was the Fool and none to mind, and Tomas heeded not,\nSlug saddleshrag on destrier and westered at the trot.\nYonge Tomas spired the girthen oake and tarried there a while,\nThen \'stead of easting back again, Tom rid another mile.\nHe cleft the black leaf shabbery and swaydin blood-daubed vine,\nCarefree took forth his knapper-foode and fettered there to dine.\nThe wodecutman found Tomas there, thrice spanned him \'round the ear\n\"Be fangs and claws for you, my ked, if sunfall shrouds you here\" \nWith axehaft brunting younge man\'s hide, the wodesman bade Tom home,\nBut Tomas mere a squallsome ked, and so he bide to roam.\nOnnerin and inneron, through garbled bole and threshy twine,\nTomas goaded stick-horse on, as ruddy sun wed pale moonshine,\nAnd there aminst the sprickly bushe, he spied the lairing of the brute,\nStepped out brightly \'pon his steed, thru\' graping branch and scraping root.\nAnd there bale-eyed the spiten Beast, all goried hornes and slives and fangs,\nYet brisky Tomas ventured on, he couched no dread, nor homeward pangs.\nThough brave Knact bidden to the grave, with woden sworde aloft\nPlucky Tom brandished at the Beast, who marred him with a scoff.\n\"What mires you here, younge smoothskin- born?\nDid you mother about me warn?\"\n\"I have no fear!\" Tom cried aloud, Horsing forward \'til Beast he growled.\n\"I shall wolfe you flesh and snap your bones, Skrind your folkland burne their homes.\nFor mocking ked to dare my rage,\nYour jibe it traps me like a cage.\nThe unclaimed ones must dread my kinde, Can never squander fear behind.\"\nSo Tomas Wanderer was no more, who never did no goode,\nSo remember poor Tomas, and roam not in the woode.";
authors[403] = "";
...
titles[435] = "WANTED\nFor expedition to the mysterious east.";
...
quotes[445] = "HALFLING FIGHTING COCKS\nExpert Marksmen, Trackers &amp; Woodsmen. Baggage Train guarding a speciality.";
...
titles[579] = "Mummies";
quotes[579] = "Go not to the mounds on moonless nights,\nseek not the dead to rise.\nRisk not the wrath that sleeps and dreams,\nheed the words of the wise.";
...
quotes[610] = "We are lucky to live in the city, my darling child.\nThere are things in the wilderness.\nDark things. Hungry things. Evil things.\nThose who stray too far beyond the edges of the\nforest are bound to meet an unhappy end.";
...
titles[624] = "MISSING";
quotes[624] = "One pair of earrings in the vicinity of Chez Louis\' Restaurant.\n REWARD for pertinent information or return of items.";
authors[624] = "Contact Frau Oppenheimer, Nordstrasse";
titles[625] = "HELP WANTED";
quotes[625] = "Fleischer\'s Famous Furters, \"The Sausage of choice for the Officers and Men of the Imperial School of Gunnery.\"\nSeveral intelligent and resourceful individuals required for a matter of some delicacy. Excellent rates of pay. Apply in person to";
...
quotes[732] = "Sir Gilbert urged his weary mount into the dreary looking village. The roads here were terrible, and he had a hard time believing this was the route to the Chapel of Shields Burning. But the lord he had stayed with the previous night had been quite emphatic.\n\nAt last, he reached what looked like an inn. Crude emblems were painted on the door. Typical peasant superstition, thought Gilbert. The knight banged his gauntleted fist on the door, but no one answered. Gilbert kept pounding, but something about this was horribly familiar. He lowered his right hand to his sword and looked around cautiously.\nAt last, a voice came from inside. \"Go away!\"\n\"You will open this door this instant,\" the Bretonnian said, lacking any measure of optimism. \"I am Sir Gilbert de Arnaud, Knight Errant...\" He got no further, as the door flew open.\n\"My most humble apologies, lord knight. I had not realised.\" The innkeeper was literally grovelling in the mud. \"The finest room is, of course, at your disposal.\"\nSir Gilbert sighed contentedly. It was good to be home.";
authors[732] = "";
titles[733] = "Did You Know...";
quotes[733] = "That the tallest player ever to stride onto a Blood Bowl field was the legendary Gurk Cloud-Scraper, storm giant half-back for the Asgard Ravens? Standing as tall as nine men, Gurk played in only one match before being barred for life for excessive violence.\nThe shortest player ever was the equally legendary Big Jobo Hairyfeet, opposing captain of the halfling Greenfield Grasshuggers team in the same game, whose sudden and quite drastic reduction in height was the main reason for Gurk\'s ban!";
authors[733] = "";
...
quotes[799] = "Never mind tempting Jeremiah Kool out of retirement - have you heard of the new Dark Elf sensation, meriann Lightning? Various teams have been queuing up to pay a fortune to the Naggaroth Nightwings after Lightning was the only player to come through the door in this year\'s Crush!\nDespite the many offers he has recieved, it seems no other teams have yet been able to tempt Meriann away from the Nightwings. He just couldn\'t refuse Naggaroth\'s guarantee of two fatalities every match - even if this means the Naggaroth cheerleaders become a little short staffed.";
authors[799] = "";
...
quotes[808] = "In 2435, the Dwarf Giants lost 9 great players when they first list a fire in the dugout to get warm, which melted that side of the pitch then performed a victorious \'high five\' in the End Zone after scoring, which tipped the floe over.\nNorse stadia are now subject to mandatory safety checks.";
authors[808] = "";
...
quotes[817] = "&lt;b&gt;Some NAF Kicking records.&lt;/b&gt;\n&lt;i&gt;Longest Kick-Off&lt;/i&gt;: 406 paces, by Ice Giant Kicker Cloudgirth Mountainhips, vs the Vynheim Valkyries, Norse Challenge Cup, 2485. A spectator watching another game was killed by the ball.\n&lt;i&gt;Longest Kick Landing in Play&lt;/i&gt;: 88 paces, by Darkside Cowboys Kicker Venom of Praetia, vs Asgard Ravens, 2487.\n&lt;i&gt;Longest Kick-Off Return&lt;/i&gt;: 62 paces, by Reikland Reaver \'Fast\' Ben Jansen, vs Elfheim Eagles, 2486.\n&lt;i&gt;Most Players Killed by Booting (Season)&lt;/i&gt;: 12, by Gouged Eye Kicker Trok Elfsplitter, 2487.\n&lt;i&gt;Most Players Killed by Booting (Single Game)&lt;/i&gt;: 3, by Dwarf Giant Grimwold Grimbreath, vs Lowdown rats 2485.";
authors[817] = "";
...
quotes[829] = "Gort Kindersnap is the longest-serving Ref currently active. The \'Grand Old Man of Blood Bowl,\' as he is affectionately known, has reffed over four complete games!\nDuring that time, Gort has sustained three concussions, two fractures and one conviction for attempted murder.\nKeep up the good work, Gort!";
authors[829] = "";
